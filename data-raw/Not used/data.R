...
#' ex_survey2_xlsx: Anonymized snippet of a real survey.
#'
...
#'
#' @format A data frame with 999 rows and 241 variables:
#' \describe{
...
#'   X}
#'   \item{p_07}{Kryss av for de programfagene du har valgt/skal velge (Kryss
...
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Fremmedspråk nivå I}
#'   \item{p_32}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Fremmedspråk nivå II}
#'   \item{p_33}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Fremmedspråk nivå III}
#'   \item{p_34}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Historie og filosofi 1}
#'   \item{p_35}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Historie og filosofi 2}
#'   \item{p_36}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Kommunikasjon og kultur 1}
#'   \item{p_37}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Kommunikasjon og kultur 2}
#'   \item{p_38}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Kommunikasjon og kultur 3}
#'   \item{p_39}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Markedsføring og ledelse 1}
#'   \item{p_40}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Markedsføring og ledelse 2}
#'   \item{p_41}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Medie- og informasjonskunnskap 1}
#'   \item{p_42}{Kryss av
#'   for de programfagene du har valgt/skal velge (Kryss kun av på de fagene som
#'   er aktuelle for deg) - Medie- og informasjonskunnskap 2}
#'   \item{p_43}{Kryss
#'   av for de programfagene du har valgt/skal velge (Kryss kun av på de fagene
#'   som er aktuelle for deg) - Økonomistyring}
#'   \item{p_44}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Økonomi og ledelse}
#'   \item{p_45}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Sosialkunnskap}
#'   \item{p_46}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Samfunnsgeografi}
#'   \item{p_47}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Sosiologi og sosialantropologi}
#'   \item{p_48}{Kryss av
#'   for de programfagene du har valgt/skal velge (Kryss kun av på de fagene som
#'   er aktuelle for deg) - Politikk og menneskerettigheter}
#'   \item{p_49}{Kryss
#'   av for de programfagene du har valgt/skal velge (Kryss kun av på de fagene
#'   som er aktuelle for deg) - Psykologi 1}
#'   \item{p_50}{Kryss av for de
#'   programfagene du har valgt/skal velge (Kryss kun av på de fagene som er
#'   aktuelle for deg) - Psykologi 2}
#'   \item{p_51}{Kryss av for de programfagene
#'   du har valgt/skal velge (Kryss kun av på de fagene som er aktuelle for deg)
#'   - Reiseliv og språk 1}
#'   \item{p_52}{Kryss av for de programfagene du har
#'   valgt/skal velge (Kryss kun av på de fagene som er aktuelle for deg) -
#'   Reiseliv og språk 2}
#'   \item{p_53}{Kryss av for de programfagene du har
#'   valgt/skal velge (Kryss kun av på de fagene som er aktuelle for deg) -
#'   Rettslære 1}
#'   \item{p_54}{Kryss av for de programfagene du har valgt/skal
...
#'   1}
#'   \item{p_58}{Kryss av for de programfagene du har valgt/skal velge (Kryss
#'   kun av på de fagene som er aktuelle for deg) - Samisk historie og samfunn
#'   2}
#'   \item{a_p}{Andre fag (du trenger ikke å ta med obligatoriske fellesfag i
...
#'   kjæreste}
#'   \item{i_03}{I hvilken grad har du fått inspirasjon eller
#'   motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Foreldre/foresatte}
#'   \item{i_04}{I hvilken grad har du fått inspirasjon
#'   eller motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Søsken}
#'   \item{i_05}{I hvilken grad har du fått inspirasjon eller motivasjon
...
#'   ungdomskolen/Vg1}
#'   \item{i_08}{I hvilken grad har du fått inspirasjon eller
#'   motivasjon til ditt valg av programområde/programfag fra følgende?  - «Åpen
#'   dag» på videregående}
#'   \item{i_09}{I hvilken grad har du fått inspirasjon
#'   eller motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Avisoppslag og -artikler}
#'   \item{i_10}{I hvilken grad har du fått
#'   inspirasjon eller motivasjon til ditt valg av programområde/programfag fra
#'   følgende?  - Populærvitenskapelige bøker og blader}
#'   \item{i_11}{I hvilken
...
#'   annonser}
#'   \item{i_13}{I hvilken grad har du fått inspirasjon eller
#'   motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Internett}
#'   \item{i_14}{I hvilken grad har du fått inspirasjon eller
#'   motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Dataspill}
#'   \item{i_15}{I hvilken grad har du fått inspirasjon eller
#'   motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Museum/vitensenter}
#'   \item{i_16}{I hvilken grad har du fått inspirasjon
#'   eller motivasjon til ditt valg av programområde/programfag fra følgende?  -
#'   Populærvitenskapelige kanaler/programmer (Discovery Channel, Newton, Animal
#'   planet, Myth busters osv.)}
#'   \item{i_17}{I hvilken grad har du fått
#'   inspirasjon eller motivasjon til ditt valg av programområde/programfag fra
#'   følgende?  - Populærvitenskapelige kanaler på YouTube, Snapchat, TikTok,
#'   osv.}
#'   \item{i_18}{I hvilken grad har du fått inspirasjon eller motivasjon
#'   til ditt valg av programområde/programfag fra følgende?  - Filmer og
#'   TV-serier}
#'   \item{fp_01}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - At jeg skulle få bruke mine
#'   talenter og evner}
#'   \item{fp_02}{Hvor viktig var følgende faktorer for deg
#'   da du valgte programområde/valgfrie programfag? - At jeg skulle få utvikle
#'   meg selv}
#'   \item{fp_03}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - At jeg skulle få arbeide
#'   kreativt}
#'   \item{fp_04}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - At jeg skulle ha det gøy med
#'   fagene}
#'   \item{fp_05}{Hvor viktig var følgende faktorer for deg da du valgte
#'   programområde/valgfrie programfag? - At jeg skulle få utfordringer å bryne
#'   meg på}
#'   \item{fp_06}{Hvor viktig var følgende faktorer for deg da du valgte
#'   programområde/valgfrie programfag? - At jeg skulle få lære om noe jeg er
#'   interessert i}
#'   \item{fp_07}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - At jeg skulle få lære om noe
#'   jeg synes er viktig og meningsfylt}
#'   \item{fp_08}{Hvor viktig var følgende
...
#'   \item{fp_10}{Hvor viktig var følgende faktorer for
#'   deg da du valgte programområde/valgfrie programfag? - Karakterene jeg hadde
#'   fra før}
#'   \item{fp_11}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - Mulighetene for gode karakterer
#'   videre}
#'   \item{fp_12}{Hvor viktig var følgende faktorer for deg da du valgte
...
#'   realfagspoeng}
#'   \item{fp_14}{Hvor viktig var følgende faktorer for deg da du
#'   valgte programområde/valgfrie programfag? - At jeg skulle holde mange
#'   muligheter for videre studier åpne}
#'   \item{fp_15}{Hvor viktig var følgende
#'   faktorer for deg da du valgte programområde/valgfrie programfag? - Hva
#'   vennene mine valgte}
#'   \item{fp_16}{Hvor viktig var følgende faktorer for deg
#'   da du valgte programområde/valgfrie programfag? - At programområdet ikke
#'   skulle kreve for mye arbeid}
#'   \item{fp_17}{Hvor viktig var følgende faktorer
#'   for deg da du valgte programområde/valgfrie programfag? - At programområdet
#'   ikke skulle være for vanskelig}
#'   \item{fp_18}{Hvor viktig var følgende
#'   faktorer for deg da du valgte programområde/valgfrie programfag? - At jeg
#'   skulle få tid til å gjøre andre ting enn skolearbeid}
#'   \item{fp_19}{Hvor
...
#'   vil i fremtiden}
#'   \item{a_fp}{Andre forhold, kommenter:}
#'   \item{up_01}{Hvor
...
#'   jeg har valgt det rette programområdet}
#'   \item{up_03}{Hvor enig er du i
...
#'   noe jeg synes er spennende}
#'   \item{up_05}{Hvor enig er du i følgende utsagn
#'   om deg og fagene på programområdet/programfag du har valgt?  - Fagene vil
#'   ta opp temaer jeg mener er meningsfylte og viktig}
#'   \item{up_06}{Hvor enig
...
#'   å ha gått på programområdet}
#'   \item{up_08}{Hvor enig er du i følgende utsagn
#'   om deg og fagene på programområdet/programfag du har valgt?  - Det betyr
#'   mye for meg å gjøre det bra i fagene}
#'   \item{up_09}{Hvor enig er du i
#'   følgende utsagn om deg og fagene på programområdet/programfag du har valgt?
...
#'   enn i fag på andre programområder}
#'   \item{up_11}{Hvor enig er du i følgende
#'   utsagn om deg og fagene på programområdet/programfag du har valgt?  - Jeg
#'   lærer lett i fagene på dette programområdet}
#'   \item{up_12}{Hvor enig er du i
#'   følgende utsagn om deg og fagene på programområdet/programfag du har valgt?
#'   - Jeg er bekymret for at jeg ikke er flink nok i fagene}
#'   \item{up_13}{Hvor
#'   enig er du i følgende utsagn om deg og fagene på programområdet/programfag
#'   du har valgt?  - Dette programområdet vil koste meg mer tid og arbeid enn
#'   om jeg hadde valgt et annet programområde}
#'   \item{up_14}{Hvor enig er du i
#'   følgende utsagn om deg og fagene på programområdet/programfag du har valgt?
...
#'   fag}
#'   \item{hm_4}{Hva synes du generelt om matematikkfaget slik du kjenner
...
#'   fra skolen? - Matematikk er viktig og meningsfylt for meg}
#'   \item{hm_7}{Hva
#'   synes du generelt om matematikkfaget slik du kjenner det fra skolen? -
#'   Matematikk er viktig for samfunnet}
#'   \item{hn_1}{Hva synes du generelt om
#'   naturfaget slik du kjenner det fra skolen? - Naturfag er vanskeligere enn
#'   de fleste andre fag}
#'   \item{hn_2}{Hva synes du generelt om naturfaget slik
#'   du kjenner det fra skolen? - Naturfag er mer interessant enn de fleste
#'   andre fag}
#'   \item{hn_3}{Hva synes du generelt om naturfaget slik du kjenner
#'   det fra skolen? - En god karakter i naturfag krever mer arbeid enn i andre
#'   fag}
#'   \item{hn_4}{Hva synes du generelt om naturfaget slik du kjenner det
...
#'   skolen? - Naturfag er viktig og meningsfylt for meg}
#'   \item{hn_7}{Hva synes
#'   du generelt om naturfaget slik du kjenner det fra skolen? - Naturfag er
#'   viktig for samfunnet}
#'   \item{b_1}{Er du jente eller gutt?}
#'   \item{b_2}{Hva er
...
#'   har fullført?}
#'   \item{b_4}{Er moren din (eller annen foresatt) i jobb?}
#'   \item{b_5}{Er faren din (eller annen foresatt) i jobb?}
#'   \item{b_6_1}{- Hvor
#'   ble du født?}
#'   \item{b_6_2}{- Hvor ble moren din (eller annen foresatt)
#'   født?}
#'   \item{b_6_3}{- Hvor ble faren din (eller annen foresatt) født?}
#'   \item{b_7_1}{Hvilke karakterer fikk du i følgende fag på slutten av Vg1?  -
#'   Matematikk 1T}
#'   \item{b_7_2}{Hvilke karakterer fikk du i følgende fag på
#'   slutten av Vg1?  - Matematikk 1P}
#'   \item{b_7_3}{Hvilke karakterer fikk du i
#'   følgende fag på slutten av Vg1?  - Norsk}
#'   \item{b_7_4}{Hvilke karakterer
#'   fikk du i følgende fag på slutten av Vg1?  - Naturfag}
#'   \item{b_8_1}{Mitt
#'   prestasjonsmål for følgende fag er å få standpunktkarakterene: - Matematikk
#'   2P}
#'   \item{b_8_2}{Mitt prestasjonsmål for følgende fag er å få
#'   standpunktkarakterene: - Samfunnsfag}
#'   \item{b_8_3}{Mitt prestasjonsmål for
#'   følgende fag er å få standpunktkarakterene: - Geografi}
#'   \item{bp_00}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Matematikk 2P}
#'   \item{bp_01}{Mitt prestasjonsmål for følgende programfag er
#'   å få standpunktkarakterene: - Matematikk R1}
#'   \item{bp_02}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Matematikk R2}
#'   \item{bp_03}{Mitt prestasjonsmål for følgende programfag er
#'   å få standpunktkarakterene: - Matematikk S1}
#'   \item{bp_04}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Matematikk S2}
#'   \item{bp_05}{Mitt prestasjonsmål for følgende programfag er
#'   å få standpunktkarakterene: - Matematikk X}
#'   \item{bp_06}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Programmering og modellering X}
#'   \item{bp_07}{Mitt prestasjonsmål for
...
#'   standpunktkarakterene: - Biologi 2}
#'   \item{bp_09}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Fysikk 1}
#'   \item{bp_10}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Fysikk 2}
#'   \item{bp_11}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Geofag X}
#'   \item{bp_12}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Geofag 1}
#'   \item{bp_13}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Geofag 2}
#'   \item{bp_14}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Informasjonsteknologi 1}
#'   \item{bp_15}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Informasjonsteknologi 2}
#'   \item{bp_16}{Mitt prestasjonsmål for følgende
#'   programfag er å få standpunktkarakterene: - Kjemi 1}
#'   \item{bp_17}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Kjemi 2}
#'   \item{bp_18}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Teknologi og forskningslære X}
#'   \item{bp_19}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Teknologi og forskningslære 1}
#'   \item{bp_20}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Teknologi og
#'   forskningslære 2}
#'   \item{bp_21}{Mitt prestasjonsmål for følgende programfag
#'   er å få standpunktkarakterene: - Antikkens kultur}
#'   \item{bp_22}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Latin 1 eller gresk 1}
#'   \item{bp_23}{Mitt prestasjonsmål for følgende
...
#'   standpunktkarakterene: - Internasjonal engelsk}
#'   \item{bp_25}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Samfunnsfaglig engelsk}
#'   \item{bp_26}{Mitt prestasjonsmål for følgende
#'   programfag er å få standpunktkarakterene: - Engelskspråklig litteratur og
#'   kultur}
#'   \item{bp_27}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Engelsk 1}
#'   \item{bp_28}{Mitt prestasjonsmål for
...
#'   standpunktkarakterene: - Fremmedspråk nivå I}
#'   \item{bp_32}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Fremmedspråk nivå II}
#'   \item{bp_33}{Mitt prestasjonsmål for følgende
...
#'   standpunktkarakterene: - Historie og filosofi 1}
#'   \item{bp_35}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Historie og filosofi 2}
#'   \item{bp_36}{Mitt prestasjonsmål for følgende
...
#'   standpunktkarakterene: - Kommunikasjon og kultur 2}
#'   \item{bp_38}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Kommunikasjon og kultur 3}
#'   \item{bp_39}{Mitt prestasjonsmål for følgende
...
#'   standpunktkarakterene: - Markedsføring og ledelse 2}
#'   \item{bp_41}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Medie- og informasjonskunnskap 1}
#'   \item{bp_42}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Medie- og
#'   informasjonskunnskap 2}
#'   \item{bp_43}{Mitt prestasjonsmål for følgende
#'   programfag er å få standpunktkarakterene: - Økonomistyring}
#'   \item{bp_44}{Mitt prestasjonsmål for følgende programfag er å få
#'   standpunktkarakterene: - Økonomi og ledelse}
#'   \item{bp_45}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Sosialkunnskap}
#'   \item{bp_46}{Mitt prestasjonsmål for følgende programfag er
#'   å få standpunktkarakterene: - Samfunnsgeografi}
#'   \item{bp_47}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Sosiologi og sosialantropologi}
#'   \item{bp_48}{Mitt prestasjonsmål for
#'   følgende programfag er å få standpunktkarakterene: - Politikk og
#'   menneskerettigheter}
#'   \item{bp_49}{Mitt prestasjonsmål for følgende
#'   programfag er å få standpunktkarakterene: - Psykologi 1}
#'   \item{bp_50}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Psykologi 2}
#'   \item{bp_51}{Mitt prestasjonsmål for følgende programfag er å
#'   få standpunktkarakterene: - Reiseliv og språk 1}
#'   \item{bp_52}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Reiseliv og språk 2}
#'   \item{bp_53}{Mitt prestasjonsmål for følgende
#'   programfag er å få standpunktkarakterene: - Rettslære 1}
#'   \item{bp_54}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Rettslære 2}
#'   \item{bp_55}{Mitt prestasjonsmål for følgende programfag er å
#'   få standpunktkarakterene: - Samfunnsøkonomi 1}
#'   \item{bp_56}{Mitt
#'   prestasjonsmål for følgende programfag er å få standpunktkarakterene: -
#'   Samfunnsøkonomi 2}
#'   \item{bp_57}{Mitt prestasjonsmål for følgende programfag
...
#'   \item{id}{Kontaktopplysninger - id}
#'   \item{orgnr}{Kontaktopplysninger -
#'   orgnr}
#'   \item{b_1_1}{Skole}
#'   \item{stato_1}{Samlet status - Ny}
#'   \item{stato_2}{Samlet status - Distribuert}
#'   \item{stato_3}{Samlet status -
#'   Noen svar}
#'   \item{stato_4}{Samlet status - Gjennomført}
#'   \item{stato_5}{Samlet status - Frafalt}
#'   \item{s_1}{Hvilke(t) valgfag hadde
...
#'   spesifiser:}
#'   \item{s_5}{Hvilket programområde (linje) går du på? - Annet*:}
